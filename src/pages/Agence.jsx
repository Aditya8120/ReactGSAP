...
import bgvideo from '../assets/BG/BG_2.webm'
  ...
  return (
    <div className='font-[font2]'>
      <div className='h-screen w-screen fixed inset-0'>
        <video autoPlay loop muted className='h-full w-full object-cover opacity-50' src={bgvideo}></video>
      </div>
      <div ref={imgRef} className='h-[20vw] w-[15vw] z-10 overflow-hidden bg-green-900 absolute rounded-4xl top-40 left-100'>
        <img ref={urlRef} className='h-full w-full object-cover' src="https://i.pinimg.com/1200x/65/18/1b/65181b447f5a34236077c5269a575410.jpg" alt="img" />
      </div>
